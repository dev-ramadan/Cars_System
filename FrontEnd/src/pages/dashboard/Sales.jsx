...
const Sales = () => {
  ...
  //  REALISTIC FALLBACK DATA (زي الهوم 100%)
  const fallbackCars = [
  ...
  return (
    <div className="p-4 bg-light min-vh-100">
      ...
      <div className="row g-3 mb-4">
        ...
        <div className="col-md-6">
          <div className="card border-0 shadow-sm rounded-4 p-3">
            <p className="text-muted small mb-1">عدد السيارات المباعة</p>
            <h4 className="fw-bold">{analytics.salesCount}</h4>
          </div>
        </div>
      ...
      <div className="card border-0 shadow-sm rounded-4 p-3 mb-4">
        ...
        <h5 className="fw-bold mb-3">اتجاهات المبيعات</h5>
      ...
      <div className="card border-0 shadow-sm rounded-4 p-3">
        ...
        <h5 className="fw-bold mb-3">السيارات المباعة</h5>
          ...
          <table className="table align-middle mb-0">
            ...
            <tbody>
              {analytics.list.map((s, i) => (
                <tr key={s.id}>
                  <td>{i + 1}</td>
                  <td className="fw-semibold">{s.Car?.company}</td>
